    ...
    <footer className="py-10 px-5 bg-card border-t border-border">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="relative h-12 w-12 rounded-xl overflow-hidden shadow-lg ring-2 ring-primary/30">
            <Image
        ...
        <p className="text-muted-foreground text-xs leading-relaxed mb-6">
          Worldwide consulting for architectural and engineering excellence.
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            ...
            <span>
              22 Mazoriya, Efrata Building, 3rd Floor, Addis Ababa, Ethiopia
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 pb-6 border-b border-border">
          <div>
            ...
            <ul className="space-y-2">
              {["About Us", "Our Team", "Credentials", "Process"].map(
                (item) => (
                  <li key={item}>
                    <button
                      onClick={() =>
