...
import { ArrowLeft, Compass, Eye, Lightbulb, Target, Sparkles } from "lucide-react"
...
const coreValues = [
  ...
  { icon: Compass, title: "Integrity", description: "Ethical practices and transparent dealings" },
  { icon: Sparkles, title: "Sustainability", description: "Building for future generations" },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        >
          <p className="text-primary text-[10px] tracking-[0.3em] uppercase mb-1">Our Direction</p>
          <h1 className="font-heading text-2xl font-bold text-foreground">Vision & Goals</h1>
        </motion.div>
      </div>
      ...
      <div className="px-5 py-6 space-y-8">
        ...
        >
          ...
          <div className="pl-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="font-heading text-lg font-semibold text-foreground">Our Vision</h2>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed italic">
              &ldquo;To be the most trusted and innovative architectural and engineering 
              consultancy in Africa, creating spaces that inspire, endure, and 
              contribute to sustainable development.&rdquo;
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-heading text-lg font-semibold text-foreground">Our Mission</h2>
          </div>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-heading text-lg font-semibold text-foreground">Core Values</h2>
          <div className="grid grid-cols-2 gap-3">
            {coreValues.map((value, index) => (
              ...
              >
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <h2 className="font-heading text-lg font-semibold text-foreground">Strategic Goals</h2>
